clear; clc
Lambda1 = 7*0.02e-3; Lambda2 = 7*0.02e-3; Lambda3 = 7*0.02e-3;
gamma1 = -20; gamma2 = 0; gamma3 = 90;
...
sorter123_20xy_777 = exp(1i*angle(exp(1i*(-P_mode1+B1))+exp(1i*(-P_mode2+B2))+exp(1i*(-P_mode3+B3))));
save('/Users/lin/Desktop/Meta/Spring 2023/MATLAB/SLM_simulation/SLM mat and bmp files/sorter123_20xy_777.mat','sorter123_20xy_777')
image = angle(exp(1i*(-P_mode1+B1))+exp(1i*(-P_mode2+B2))+exp(1i*(-P_mode3+B3)))+pi;
alpha = 152;
SLM_image = uint8(image*alpha/(2*pi));
imwrite(SLM_image,'/Users/lin/Desktop/Meta/Spring 2023/MATLAB/SLM_simulation/SLM mat and bmp files/SLM_sorter123_20xy_777.bmp','bmp')

output_field1 = fftshift(fft2(fftshift(mode1.*sorter123_20xy_777)));
output_intensity1 = abs(output_field1).^2;
output_field2 = fftshift(fft2(fftshift(mode2.*sorter123_20xy_777)));
output_intensity2 = abs(output_field2).^2;
output_field3 = fftshift(fft2(fftshift(mode3.*sorter123_20xy_777)));
